...
2.第二天早上起来从换乘中心出发（天空蓝颜色路线）直达玉屏索道(从上往下看风景真的不错);
3.由玉屏索道上山可以去看一下迎客松(深蓝色路线和蓝紫色路线)，看完之后直接出发去白云宾馆搭建帐篷⛺(因为下午的话会有很多人搭帐篷，太迟的话会没有位置)，中间经过一线天，挺险峻的;
4.中午解决午餐，下午去光明顶，飞来石（视野很开阔）,走去排云溪站（一路风景特别好，淡紫色路线），坐地轨缆车上来（青色路线），稍作休息就可以吃晚餐啦~晚上可以看星星（一颗两颗连成线。。。。略冷的）;
5.第三天下山（淡绿色路线），可以早起去看光明顶看完日出再出发，中午13：00就可以出发回杭啦~;
```
